const Card = ({author = "Anonymous", designation = "Not assigned"}) => {
    return (
        <>
            <figure className="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-800 mb-4">
                <img className="w-24 h-24 md:w-48 md:h-auto md:rounded-none rounded-full mx-auto" src="./vite.svg" alt="" width="384" height="512" />
